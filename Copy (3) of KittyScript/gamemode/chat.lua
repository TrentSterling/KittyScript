...
function VoteCopNoob( ply, args )	
ply:SetModel( "models/kleiner.mdl" ); 

		ply:SetPos(Vector(3250.9805, -3190.3970, 776.6063)+ Vector(math.random( -50, 50 ),math.random( -50, 50 ), 0) )
	return "(" .. ply:GetNWString( "RPName" ) .. ")[OOC] HOLY FUCK! IM A MINGE!!!!";
end
AddChatCommand( "/votecop", VoteCopNoob );




function MelonNoob( ply, args )	
ply:SetModel( "models/props_junk/watermelon01.mdl" ); 

		ply:SetMoveType(4);
	return "(" .. ply:GetNWString( "RPName" ) .. ")[OOC] HOLY FUCK! IM A MELON!!!!!";
end
AddChatCommand( "/tacos", MelonNoob );
