--LOL MALLEY KAN FIX IT MOAR
-- Fix for gmod 2008 by Botman.
-- Other credits goes to the CGRP community for helping me to sort out the correct animations.
------
-- NPC Animations
-- March 24, 2007
-- Rick Darkaliono
...
Models = {
	 ...
	 "models/CPLCPY.mdl",  
		 ...
		 "models/Odessa.mdl",
		 "models/barney.mdl",
		 "models/Humans/police.mdl",
		 "models/kleiner.mdl",
		 "models/Police_1337.mdl",
		 "models/dapopo.mdl",
         "models/Humans/charple01.mdl",
		 "models/Humans/Group01/expe_07.mdl"
...
NPCAnim.CitizenFemaleAnim["smgrun"] = 333
NPCAnim.CitizenFemaleAnim["smgwalk"] = 335
...
NPCAnim.CitizenFemaleAnim["smgaimcrouchwalk"] = 336
NPCAnim.CitizenFemaleAnim["smgaimrun"] = 334
NPCAnim.CitizenFemaleAnim["smgreload"] = 337
NPCAnim.CitizenFemaleAnim["smgfire"] = 336

NPCAnim.CitizenFemaleAnim["ar2idle"] = 1
NPCAnim.CitizenFemaleAnim["ar2walk"] = 335
NPCAnim.CitizenFemaleAnim["ar2run"] = 333
...
NPCAnim.CitizenFemaleAnim["ar2reload"] = 337
NPCAnim.CitizenFemaleAnim["ar2fire"] = 281

NPCAnim.CitizenFemaleAnim["shotgunidle"] = 1
NPCAnim.CitizenFemaleAnim["shotgunwalk"] = 335
NPCAnim.CitizenFemaleAnim["shotgunrun"] = 333
...
NPCAnim.CitizenFemaleAnim["shotgunreload"] = 337
NPCAnim.CitizenFemaleAnim["shotgunfire"] = 288

NPCAnim.CitizenFemaleAnim["crossbowidle"] = 1
NPCAnim.CitizenFemaleAnim["crossbowwalk"] = 335
NPCAnim.CitizenFemaleAnim["crossbowrun"] = 333
...
NPCAnim.CitizenFemaleAnim["crossbowreload"] = 337
...
NPCAnim.CitizenFemaleAnim["meleefire"] = 340

NPCAnim.CitizenFemaleAnim["rpgidle"] = 1
NPCAnim.CitizenFemaleAnim["rpgwalk"] = 335
NPCAnim.CitizenFemaleAnim["rpgrun"] = 333
...
NPCAnim.CitizenFemaleAnim["physgunwalk"] = 335
NPCAnim.CitizenFemaleAnim["physgunrun"] = 333
...
NPCAnim.CitizenFemaleAnim["physguncrouchwalk"] = 8
NPCAnim.CitizenFemaleAnim["physguncrouch"] = 5
NPCAnim.CitizenFemaleAnim["physgunaimcrouch"] = 5
...
for k, v in pairs( NPCAnim.CombineMetroModels ) do
	...
	NPCAnim.CombineMetroAnim["pistolcrouch"] = 60
	...
	NPCAnim.CombineMetroAnim["pistolaimcrouch"] = 60
	...
	NPCAnim.CombineMetroAnim["smgrun"] = 10
	NPCAnim.CombineMetroAnim["smgwalk"] = 6
	NPCAnim.CombineMetroAnim["smgaimidle"] = 302
	NPCAnim.CombineMetroAnim["smgaimwalk"] = 340
	NPCAnim.CombineMetroAnim["smgcrouchwalk"] = 8
	NPCAnim.CombineMetroAnim["smgcrouch"] = 60
	NPCAnim.CombineMetroAnim["smgaimcrouch"] = 60
	NPCAnim.CombineMetroAnim["smgaimcrouchwalk"] = 8
	NPCAnim.CombineMetroAnim["smgaimrun"] = 351
	...
	NPCAnim.CombineMetroAnim["ar2aimrun"] = 351
	NPCAnim.CombineMetroAnim["ar2crouchwalk"] = 8
	NPCAnim.CombineMetroAnim["ar2crouch"] = 60
	NPCAnim.CombineMetroAnim["ar2aimcrouch"] = 60
	...
	NPCAnim.CombineMetroAnim["shotguncrouch"] = 60
	NPCAnim.CombineMetroAnim["shotgunaimcrouch"] = 60
	...
	NPCAnim.CombineMetroAnim["crossbowcrouch"] = 60
	NPCAnim.CombineMetroAnim["crossbowaimcrouch"] = 60
	...
	NPCAnim.CombineMetroAnim["meleeaimcrouch"] = 60
	NPCAnim.CombineMetroAnim["meleecrouchwalk"] = 8
	NPCAnim.CombineMetroAnim["meleecrouch"] = 60
...
function ccModelList( ply, cmd, args )
	...
	if( ply:EntIndex() == 0 ) then
		...
		Msg( "Only players can do this command, not console\n" );
		return;
	
	end

	ply:PrintMessage( 2, "USE setmodel TO CHANGE MODEL. HERE ARE THE MODELS AVAILABLE: " );
...
--concommand.Add( "modellist", ccModelList );
...
function ccSetModel( ply, cmd, args )
	...
	if( #args < 1 ) then
		...
		ply:PrintMessage( 2, "No model selected" );
		return;
...
--concommand.Add( "setmodel", ccSetModel );
...
function NPCSetupMove( ply, move )
	...
	// Below is an example of how you can raise certain teams/players speeds...
	--[[ 
	if( ply:KeyDown( IN_SPEED) and ply:Team() == 12 ) then
	
	    moveSetMaxClientSpeed( 250 ); ]]--
