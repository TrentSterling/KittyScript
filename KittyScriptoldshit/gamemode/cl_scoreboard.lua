...
function GM:GetTeamScoreInfo()
	...
	for id,pl in pairs( player.GetAll() ) do
		...
		PlayerInfo.Name = (pl:GetNWString( "RPName" ) .. " -- " .. pl:Nick())
...
function GM:HUDDrawScoreBoard()
	...
	boardWidth = math.Clamp( boardWidth, 600, 1000 )
	...
	draw.RoundedBox(8,  xOffset-2, yOffset-2, boardWidth+4, boardHeight+4, Color(75, 75, 75, 150))
	draw.RoundedBox(8,  xOffset, yOffset, boardWidth, GAMEMODE.ScoreDesign.HeaderY, Color(25, 25, 25, 150))
	...
	local gamemodeName = "KittyScript - John '[MT]OMalley' Dorian"
