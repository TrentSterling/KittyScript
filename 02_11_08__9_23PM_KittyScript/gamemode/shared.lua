function testpanel()
	...
	if !trace.HitNonWorld then
		...
		--menu123:AddOption("TESTING THIS YOU HOEBAG", function() player:ConCommand("rp_teleport") gui.EnableScreenClicker(false) clicker=false end )
		menu123:AddOption("Options", function() gui.EnableScreenClicker(false) clicker=false end )
		menu123:AddSpacer()
		menu123:AddOption("Name: " .. player:Nick(), function() gui.EnableScreenClicker(false) clicker=false end )
		...
		local class = target:GetClass();
			...
			--if( target:GetPos() ) then 
				if( player:GetPos():Distance( target:GetPos() ) < 100 ) then
					...
					menu123:AddSpacer()
					menu123:AddOption("Name: " .. target:Nick(), function() gui.EnableScreenClicker(false) clicker=false end )
					menu123:AddOption("Title: " .. target:GetNWString( "jobtitle" ), function() gui.EnableScreenClicker(false) clicker=false end )
					menu123:AddSpacer()
					local submenu = menu123:AddSubMenu( "Functions" )
					submenu:AddOption( "Punch", function() player:ConCommand("say /me attempts to punch " .. target:Nick() .. ".") gui.EnableScreenClicker(false) clicker=false end )
					submenu:AddOption( "Stick Tounge Out", function() player:ConCommand("say /me sticks their tounge out at " .. target:Nick() .. ".") gui.EnableScreenClicker(false) clicker=false end )
					submenu:AddOption( "Pokes", function() player:ConCommand("say /me pokes " .. target:Nick() .. ".") gui.EnableScreenClicker(false) clicker=false end )
					local adminsubmenu = menu123:AddSubMenu( "Admin" )
					...
					adminsubmenu:AddOption( "Explode player", function() player:ConCommand("rp_explode " .. target:Nick()) gui.EnableScreenClicker(false) clicker=false end )
					...
					adminflagsubmenu:AddOption( "Allow Vortigaunt", function() player:ConCommand("rp_allowvort " .. target:Nick()) gui.EnableScreenClicker(false) clicker=false end )
					adminflagsubmenu:AddSpacer()
					adminflagsubmenu:AddOption( "Civil Protection", function() gui.EnableScreenClicker(false) clicker=false end )
					adminflagsubmenu:AddOption( "Allow Scanner", function() player:ConCommand("rp_allowscanner " .. target:Nick()) gui.EnableScreenClicker(false) clicker=false end )
					adminflagsubmenu:AddOption( "Allow Shield Scanner", function() player:ConCommand("rp_allowshieldscanner " .. target:Nick()) gui.EnableScreenClicker(false) clicker=false end )
				else
